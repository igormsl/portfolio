...
document.addEventListener('click',e=>{
 ...
 const v=e.target.closest('[data-video]');if(v){document.getElementById('video-title').textContent=v.dataset.title;document.getElementById('video-error').hidden=true;show(videoDialog,v);player.src=v.dataset.src;player.load();player.play().catch(()=>{});return;}
